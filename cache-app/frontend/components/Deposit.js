...
export default function Deposit(deposit) {
	return (
			<div className="deposit-details">
				...
				<DeleteDeposit id={deposit.deposit.id} accountId={deposit.accountId} accountBalance={deposit.accountBalance} depositAmount={deposit.deposit.amount}>Delete</DeleteDeposit>
			</div>
	)
}